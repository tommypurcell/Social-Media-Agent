...
const Login = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    const onboardingComplete = localStorage.getItem('social_media_agent_onboarding_completed') === 'true';
      ...
      >
        ...
        >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="block w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all outline-none"
                />
                <button
                  type="button"
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <button
              type="button"
              className="w-full inline-flex justify-center items-center px-4 py-2.5 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors"
            >
        ...
        <p className="mt-6 text-center text-sm text-gray-600">
          ...
          <button
            onClick={() => {
              localStorage.removeItem('social_media_agent_onboarding_completed');
              navigate('/');
            }}
