      ...
      <div className="bg-white w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="bg-orange-600 p-6 flex justify-between items-start text-white">
          <div className="flex gap-4">
            ...
            <div>
              <h2 className="text-xl font-bold">Plan Posts</h2>
              <p className="text-orange-100 text-sm opacity-90">Configure your daily social media content plan</p>
            </div>
          </div>
        ...
        <div className="p-6 overflow-y-auto space-y-8 flex-1">
          ...
          {/* Post Count */}
          <div>
            <h3 className="text-sm font-semibold bg-white text-gray-800 mb-2">How many posts do you want to generate?</h3>
            <input 
              type="number" 
              min={1}
              max={10}
